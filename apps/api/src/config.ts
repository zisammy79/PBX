...
const ConfigSchema = z.object({
  ...
  apiBindHost: z.string().default('0.0.0.0'),
  ...
  asteriskContainer: z.string().default('pbx-asterisk'),
  ...
  asteriskMohSyncRoot: z.string().min(1).optional(),
  campaignOriginateEnabled: z.coerce.boolean().default(false),
...
export function loadConfig(): AppConfig {
  ...
  const result = ConfigSchema.safeParse({
    ...
    apiBindHost: process.env.API_BIND_HOST,
    ...
    asteriskContainer: process.env.PBX_ASTERISK_CONTAINER,
    ...
    asteriskMohSyncRoot: process.env.ASTERISK_MOH_SYNC_ROOT,
    campaignOriginateEnabled: process.env.CAMPAIGN_ORIGINATE_ENABLED,
