...
- External AI: **OpenAI Realtime implemented** — configure via Platform Owner UI or optional env fallback; live verification **NOT_TESTED** without credentials
- Stripe: **TEST MODE IMPLEMENTED** — configure via Platform Owner UI; live verification **NOT_TESTED** without credentials
- PSTN: **generic trunk path implemented** — configure SIP carrier profiles in Platform Owner UI; production verification **NOT_PERFORMED** without carrier credentials

## Telephony

- Deterministic SIP-to-AI path proven locally; **OpenAI Realtime adapter implemented** — configure API key in Platform Owner UI → Integrations → AI
