...
export const PLATFORM_ROLE_PERMISSIONS: Record<PlatformRole, readonly Permission[]> = {
  platform_super_admin: [
    ...
    Permission.PLATFORM_CATALOG_MANAGE,
  ],
...
export const TENANT_ROLE_PERMISSIONS: Record<TenantRole, readonly Permission[]> = {
  tenant_owner: [
    ...
    Permission.TENANT_MEDIA_MANAGE,
    Permission.TENANT_VOICEMAIL_MANAGE,
    Permission.TENANT_CAMPAIGN_MANAGE,
    Permission.TENANT_PHONEBOOK_MANAGE,
    Permission.TENANT_PROVISIONING_MANAGE,
    Permission.TENANT_PEER_OPERATE,
